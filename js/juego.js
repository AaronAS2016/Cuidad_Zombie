...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 100, 245, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 140, 350, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 280, 120, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 850, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 250, 460, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 350, 250, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 550, 70, 30, 30, 1),
    ...
    new Obstaculo('imagenes/bache.png', 90, 480, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 450, 250, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 820, 100, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 800, 250, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 150, 430, 30, 15, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 420, 430, 30, 15, 1)
  ...
  enemigos: [
    ...
    new ZombieCaminante('imagenes/zombie1.png', 200, 300, 10, 10, 1, {
        desdeX: 0,
        hastaX: 1000,
        desdeY: 0,
        hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie1.png', 400, 400, 10, 10, 1, {
        desdeX: 0,
        hastaX: 1000,
        desdeY: 0,
        hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png', 600, 500, 10, 10, 1, {
        desdeX: 0,
        hastaX: 1000,
        desdeY: 0,
        hastaY: 1000
    ...
    new ZombieCaminante('imagenes/zombie3.png', 490, 105, 10, 10, 1, {
        desdeX: 0,
        hastaX: 1000,
        desdeY: 0,
        hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie3.png', 800, 120, 10, 10, 1, {
        desdeX: 0,
        hastaX: 1000,
        desdeY: 0,
        hastaY: 577
    ...
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 1, {
        desdeX: 0,
        hastaX: 961,
        desdeY: -120,
        hastaY: 620
    }, "v"),
    new ZombieConductor('imagenes/tren_vertical.png', 675, 0, 30, 90, 4, {
        desdeX: 0,
        hastaX: 961,
        desdeY: -120,
        hastaY: 620
    }, "v"),
    new ZombieConductor('imagenes/tren_horizontal.png', 300, 322, 90, 30, 8, {
        desdeX: -100,
        hastaX: 1000,
        desdeY: 0,
        hastaY: 577
